...
//*****************************************************************************
// MACRO: PRINT_STR - prints a buffer to a console
// INPUT:   * bufReg: pointer to null-terminated cstring in a register
//
// OUTPUT:  * N/A
//
// MODIFIES: * X0
...
// 2) Call putstring to print buffer to console
//*****************************************************************************
.macro PRINT_STR bufReg
  MOV X0, \bufReg         // load pointer
  BL putstring            // print buffer
.endm
